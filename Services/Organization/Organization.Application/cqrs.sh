...
public record Create${class_name}(${entity_properties//public /} | tr '\n' ', ') : IRequest<bool>;
...
public record Edit${class_name}(${entity_properties//public /} | tr '\n' ', ') : IRequest<bool>;
...
public record Delete${class_name}(string Id) : IRequest<bool>;
...
public record Get${class_name}(string Id) : IRequest<${class_name}>;
