...
public class EmployeeController : BaseController
{
    ...
    public async Task<IActionResult> GetEmployees()
    {
        ...
        var response = await client.GetAsync($"http://localhost:5001/api/Employees?companyId={companyId}");
    ...
    public async Task<IActionResult> Add(CreateUserDto request)
    {
        ...
        var response = await client.PostAsync($"http://localhost:5001/api/Employees?companyId={_sharedIdentityService.GetCompanyId}", stringContent);
